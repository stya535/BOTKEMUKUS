...
class TSSLSocket(TSocket.TSocket, TSSLBase):
    def __init__(self, host='PrankBots', port=9090, *args, **kwargs):
        """Positional arguments: ``host``, ``port``, ``unix_socket``

        KATA KUNCI ARGUMEN: ``keyfile``, ``certfile``, ``cert_reqs``,
        ...
        KATA KUNCI ALTERNATIF: (Python 2.7.9 or later)
